...
struct UserModel : Identifiable{
    ...
    static func getUsers() -> [UserModel] {
        return [
            ...
            .init(username: "Josue", profilePicture: "person-5", city: "Sao Paolo, Brazil", isVerified: false),
            .init(username: "Vanessa", profilePicture: "person-6", city: "Bogota, Colombia", isVerified: false),
            .init(username: "someone", profilePicture: "person-7", city: "Brazil", isVerified: true),
            .init(username: "Fabian", profilePicture: "person-8", city: "Yucatan, Mexico", isVerified: true),
